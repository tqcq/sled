          ...
          is_swappable<T, U>::value
              && ((decltype(detail::swap_adl_tests::uses_std<T, U>(0))::value
                  ...
                  || (!decltype(detail::swap_adl_tests::uses_std<T, U>(
                          0))::value
                      && detail::swap_adl_tests::is_adl_swap_noexcept<T, U>::
                          value))> {};
#endif
#endif
...
template<class T = tl::detail::i_am_secret,
         class U,
         class Ret = tl::detail::conditional_t<
             std::is_same<T, tl::detail::i_am_secret>::value,
             tl::detail::decay_t<U>,
             T>>
inline constexpr optional<Ret>
make_optional(U &&v)
...
make_optional(Args &&...args)
{
    return optional<T>(tl::in_place, std::forward<Args>(args)...);
}
...
make_optional(std::initializer_list<U> il, Args &&...args)
{
    return optional<T>(tl::in_place, il, std::forward<Args>(args)...);
}
}// namespace sled
